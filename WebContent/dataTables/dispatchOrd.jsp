 ...
 <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div id="layoutSidenav_content">
          <main>
              <div class="container-fluid">
                  <h1 class="mt-4">dispatched  orders</h1>
                
                 
                  <div class="card mb-4">
                      <div class="card-header"><i class="fas fa-table mr-1"></i>dispatched orders </div>
                      ...
                      <div class="card-body">
                          <div class="table-responsive">
                              <table class="table table-bordered table-hover table-striped" id="example1" width="100%" cellpadding="5">
                               ...
                               <button  id="wbutton" value="delivered" class="btn btn-md btn-primary pl-6 ">deliver</button>
                          </div>
                      </div>
                  </div>
              </div>
       			...
       			$("#example1").dataTable(
       					{
       						...
       						"bServerSide":false,
       						"sort":false,
       						"sAjaxSource":"../servlet/DataTable?name=dispatchOrd",
       						"aoColumns":
       						[
       							{
